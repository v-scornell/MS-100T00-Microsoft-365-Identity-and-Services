...
16. Remain logged into the domain controller (LON-DC1) VM with the Microsoft 365 admin center open in your browser for the next task.
...
11. In the **Add a group** wizard, on the **Choose a group type** page, the **Microsoft 365 (recommended)** option should be selected by default. If it isn't, then select this option now. Select **Next**. 
